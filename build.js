...
async function build() {
  ...
  const HERO_PICKS = [
    ...
    { url: 'https://cdn.sanity.io/images/juhmq0dg/production/848718f38da796245438d8ffb9e52533e04f0414-4032x3024.jpg', pos: 'center 45%', alt: 'A facilitator reading to children seated in a circle' },
  ];
  const heroSrc = (url) =>
